...
public:
	...
	void hideArea(betri::vis::BTStatusBits _bit, bool _hide);
	 ...
	 *  @return All visible?
	 */
	bool areaVisible(betri::vis::BTStatusBits _bit);
	...
	ACG::SceneGraph::StatusNodeT<BezierTMesh, betri::vis::BTAreaNodeMod<BezierTMesh>>*
		areaNode()
	{
		return areaNode_;
	}
	...
	ACG::SceneGraph::StatusNodeT<BezierTMesh, betri::vis::BTHandleNodeMod<BezierTMesh>>*
		handleNode()
	{
		return handleNode_;
	}
	...
	ACG::SceneGraph::StatusNodeT<BezierTMesh, betri::vis::BTFeatureNodeMod<BezierTMesh>>*
		featureNode()
	{
		return featureNode_;
	}
...
private:
	...
	/// Area selection Vis
	ACG::SceneGraph::StatusNodeT<BezierTMesh, betri::vis::BTAreaNodeMod<BezierTMesh>> *areaNode_;

	/// Handle selection Vis
	ACG::SceneGraph::StatusNodeT<BezierTMesh, betri::vis::BTHandleNodeMod<BezierTMesh>> *handleNode_;

	/// Feature selection Vis
	ACG::SceneGraph::StatusNodeT<BezierTMesh, betri::vis::BTFeatureNodeMod<BezierTMesh>> *featureNode_;
	...
	BTStatusViewNodeT<BezierTMesh> *statusView_;
